...
export const ASTEROID_BELTS_BY_STAR: Record<string, AsteroidBeltData[]> = {
  ...
  'alpha-centauri': [
    ...
    { name: 'Proxima Warm Belt', innerAU: 0.35, outerAU: 0.45, color: '#9a8f7a' },
    { name: 'Proxima Cold Belt', innerAU: 1, outerAU: 4, color: '#8a8378' },
    { name: 'Proxima Outer Belt', innerAU: 28, outerAU: 32, color: '#6a7a8a' },
    { name: 'Rigil Kentaurus Belt', innerAU: 2.8, outerAU: 3.4, color: '#9a8f7a' },
  ],
  ...
  sirius: [{ name: 'Sirius Wreckage Belt', innerAU: 8, outerAU: 12, color: '#7a7268' }],
  'luyten-726-8': [{ name: 'Luyten Debris Belt', innerAU: 0.3, outerAU: 0.4, color: '#8a8378' }],
