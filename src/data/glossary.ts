...
const ENTRIES: { terms: string[]; term: string; text: string }[] = [
  ...
  { terms: ['research'], term: 'Research', text: 'Points spent unlocking technologies. In Simple mode, research labs produce them into your chosen tree — and all research also raises productivity.' },
